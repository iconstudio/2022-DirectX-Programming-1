...
public:
	...
	virtual void OnPrepareRender(P3DGrpCommandList cmdlist, int nPipelineState = 0);
	virtual void Render(P3DGrpCommandList cmdlist, GameCamera* pCamera, int nPipelineState = 0);
