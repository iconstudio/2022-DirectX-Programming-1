...
XMFLOAT4X4* GamePipeline::m_pxmf4x4World = NULL;
XMFLOAT4X4* GamePipeline::m_pxmf4x4ViewProject = NULL;
GameViewport* GamePipeline::m_pViewport = NULL;

void GamePipeline::SetViewPerspectiveProjectTransform(XMFLOAT4X4* pxmf4x4ViewPerspectiveProject)
{
	m_pxmf4x4ViewProject = pxmf4x4ViewPerspectiveProject;
}

void GamePipeline::SetViewOrthographicProjectTransform(XMFLOAT4X4* pxmf4x4OrthographicProject)
{
